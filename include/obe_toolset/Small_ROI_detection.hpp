...
//include guard
#ifndef SMALL_ROI_DETECTION_H
#define SMALL_ROI_DETECTION_H
...
std::list<CV_ImAndPose> Small_ROI_detection(CV_ImAndPose imAndPose, double camera_vertical_FOV_degrees = 50.0852, double camera_horizontal_FOV_degrees = 63.8418);

#endif //defined SMALL_ROI_DETECTION_H
