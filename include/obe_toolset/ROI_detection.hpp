...
std::list<CV_ImAndPose> ROI_detection(CV_ImAndPose img, double AGL_feet);//, double Roll_deg = 0, double Yaw_deg = 0); //the RPY stuf is commented out (even though it defaults to zero) because it doesn't do anything at the moment.
